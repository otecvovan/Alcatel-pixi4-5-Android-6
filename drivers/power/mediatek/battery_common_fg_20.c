...
void mt_battery_GetBatteryData(void)
{
	...
	static signed int batteryconstanttemp = 30;
	...
	#ifdef CONFIG_HIGH_LOW_TEMPERRATURE_TEST
	BMT_status.temperature = batteryconstanttemp;
	temperature = batteryconstanttemp;
	#endif
