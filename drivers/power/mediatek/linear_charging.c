...
CHR_CURRENT_ENUM       g_temp_CC_value_limit = CHARGE_CURRENT_700_00_MA;
...
#if !defined(CONFIG_MTK_JEITA_STANDARD_SUPPORT)
			if (batt_cust_data.high_battery_voltage_support)
				/*[854184] set cv_charge 4375v by limng.zhu at 20151110 begin*/
				cv_voltage = BATTERY_VOLT_04_375000_V;
			/*[854184] set cv_charge 4375v by limng.zhu at 20151110 end*/
			else
				cv_voltage = BATTERY_VOLT_04_200000_V;
			/*[1163040] set cv_charge 4350v by zhuqiang at 20151215 begin*/
			cv_voltage = g_cv_voltage;
			/*[1163040] set cv_charge 4350v by zhuqiang at 20151215 end*/
			battery_charging_control(CHARGING_CMD_SET_CV_VOLTAGE, &cv_voltage);
			#if defined(CONFIG_MTK_HAFG_20)
			g_cv_voltage = cv_voltage;
			#endif
...
PMU_STATUS BAT_TopOffModeAction(void)
{
	...
	if (batt_cust_data.high_battery_voltage_support)
		...
		/*[854184] set cv_charge 4375v by limng.zhu at 20151110 begin*/
		cv_voltage = 4350;
	/*[854184] set cv_charge 4350v by limng.zhu at 20151110 end*/
	/*[1163040] set cv_charge 4375v by zhuqiang at 20151215 end*/
	else
		cv_voltage = 4200;
