...
static void mt_battery_update_EM(struct battery_data *bat_data)
{
    ...
    bat_data->BAT_batt_id=BMT_status.id_vol;    /* [749936]Add battery id attribute under sys/class/power_supply/battery by [bin.song.hz] at [2014-8-25] */
	/* Dual battery */
...
void mt_battery_GetBatteryData(void)
{
	...
	#if BATT_ID_CHECK_SUPPORT
	unsigned int bat_id_vol; //[FR571989][add battery id] by [wangxingxing] at [20140212]
	#endif
...
/*modified by zhuqiang for pr1131246 begin */
	charger_vol = battery_meter_get_charger_voltage();
	#ifdef TARGET_BUILD_TEMPERATURE
	temperature = 30;
	#else
	...
	/*modified by zhuqiang for pr1131246 end */
    #if BATT_ID_CHECK_SUPPORT
	...
	/*[2050594] remove average buff for mmitest by zhuqiang at 20160504 bigen*/
	...
	/*[2050594] remove average buff for mmitest by zhuqiang at 20160504 end*/
...
/*modified by zhuqiang for pr1053848 begin*/ 
#if BATT_ID_CHECK_SUPPORT
#define CHG_MIN_VALID_BATT_ID_BYD  324
#define CHG_MAX_VALID_BATT_ID_BYD  524
#define CHG_MIN_VALID_BATT_ID_VEKEN  130
#define CHG_MAX_VALID_BATT_ID_VEKEN  330
...
{	
   ...
   if((BMT_status.id_vol < CHG_MIN_VALID_BATT_ID_VEKEN) || ((BMT_status.id_vol > CHG_MAX_VALID_BATT_ID_BYD) && (BMT_status.id_vol < CHG_MIN_VALID_BATT_ID_SCUD)) || (BMT_status.id_vol > CHG_MAX_VALID_BATT_ID_SCUD)) /*battery id error*/
    {
...
#endif
#endif
/*modified by zhuqiang for pr1053848 end*/ 
...
void do_chrdet_int_task(void)
{
	if (g_bat_init_flag == KAL_TRUE) {
		...
		if (BMT_status.bat_vol > 0) {
			mt_battery_update_status();
			skip_battery_update = KAL_FALSE; // [981730] modify the battery data update not in time by liming.zhu at 20151125 
