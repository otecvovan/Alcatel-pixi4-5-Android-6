...
#define CONFIG_ENABLE_PROXIMITY_ASSISTANCE_BY_GSENSOR
...
typedef enum
{
    PROX_ASSIST_MODE_WEAK = 0,
    PROX_ASSIST_MODE_NORMAL,
    PROX_ASSIST_MODE_ENHANCED,
    PROX_ASSIST_MODE_UNKNOWN
} ProxAssistanceMode_e;
/*--------------------------------------------------------------------------*/
