...
static void accdet_work_callback(struct work_struct *work)
{
	...
	mutex_lock(&accdet_eint_irq_sync_mutex);
      ...
      /* defect2276554:modify by wei.zhang at 20160607 start */
     /*  if (1 == eint_accdet_sync_flag)
		switch_set_state((struct switch_dev *)&accdet_data, cable_type);
      */
       if(1 == eint_accdet_sync_flag)
	{
		if((accdet_data.state == 2)&&(cable_type == 1))
		switch_set_state((struct switch_dev *)&accdet_data, 0);
		switch_set_state((struct switch_dev *)&accdet_data, cable_type);
	}  
        /* defect2276554:modify by wei.zhang at 20160607 end */
	else
