...
/*modified by jiaqing.yang for pr1442138 begin*/
#if 0
	if (ucScanTimeoutTimes > SCAN_DONE_TIMEOUT_TIMES_LIMIT) {
#else
	if (ucScanTimeoutTimes > SCAN_DONE_TIMEOUT_TIMES_LIMIT && prAdapter->fgTestMode == FALSE) {
#endif
/*modified by jiaqing.yang for pr1442138 end*/
