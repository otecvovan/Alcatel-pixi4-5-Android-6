...
WLAN_STATUS wlanLoadManufactureData(IN P_ADAPTER_T prAdapter, IN P_REG_INFO_T prRegInfo)
{
	...
	if (prRegInfo->fg2G4BandEdgePwrUsed) {
		...
		//modify by bin.song.hz for WIFI BAND EDGE ISSUE at 2016.4.1 begin
		rCmdEdgeTxPwrLimit.cBandEdgeCert = 0x00;
        //modify by bin.song.hz for WIFI BAND EDGE ISSUE at 2016.4.1 end
