...
/*task799146 modify by zhanyong.yin at 20151025 begin*/
else  if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName)))
	{
  ...
  else  if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670AF_MIPI_RAW, currSensorName)))
        {
		printk("kdCISModulePower--On get in---SENSOR_DRVNAME_OV5670AF_MIPI_RAW \n");
		//disable inactive sensor
		if(pinSetIdx == 0 || pinSetIdx == 2) {//disable sub
			if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMRST]) {
			 mtkcam_gpio_set(1,CAMRST,pinSet[1][IDX_PS_CMRST+IDX_PS_OFF]);   		       
		...
		mdelay(1);
	        ...
	        mdelay(1);//5ms
		       ...
		       //AF_VCC
	            ...
	            //AF enable pin
		mtkcam_gpio_set(pinSetIdx, CAMLDO,
						pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_ON]);
	        mdelay(1);
        ...
        {
		printk("kdCISModulePower--On get in---SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW \n");
		//disable inactive sensor
		if(pinSetIdx == 0 || pinSetIdx == 2) {//disable sub
			if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMRST]) {
			 mtkcam_gpio_set(1,CAMRST,pinSet[1][IDX_PS_CMRST+IDX_PS_OFF]);   		       
    ...
    else  if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K5E8YXFF_MIPI_RAW, currSensorName)))
        {
		printk("kdCISModulePower--On get in---SENSOR_DRVNAME_S5K5E8YXFF_MIPI_RAW \n");
		//disable inactive sensor
		if(pinSetIdx == 0 || pinSetIdx == 2) {//disable sub
			if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMRST]) {
			 mtkcam_gpio_set(1,CAMRST,pinSet[1][IDX_PS_CMRST+IDX_PS_OFF]);   		       
	...
	{
		printk("TCL: aad pinSetIdx kdCISModulePower--On get in---SENSOR_DRVNAME_OV2680_MIPI_RAW \n");
		//disable inactive sensor
		if(pinSetIdx == 0 || pinSetIdx == 2) {//disable sub
			if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMRST]) {
...
/*task799146 modify by zhanyong.yin at 20151025 end*/
			...
			//mtkcam_gpio_set(pinSetIdx, CAMLDO, 1); //task799146 modify by zhanyong.yin at 20151025
...
/*task799146 modify by zhanyong.yin at 20151025 begin*/
			...
			if (GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMRST]) {
			 ...
			 if(0 == strcmp(Back_Camera,"sp2509"))
	   		       {
	...
	else if ((pinSetIdx == 1)&&(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2508_MIPI_RAW, currSensorName)))) {
		...
		else if ((pinSetIdx == 0)&&(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW, currSensorName)))) {
...
/*task799146 modify by zhanyong.yin at 20151025 begin*/
    ...
    {
		PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW\n");
		PK_DBG("[OFF]pinSetIdx:%d \n",pinSetIdx);
    ...
    {
		PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_S5K5E8YXFF_MIPI_RAW\n");
		PK_DBG("[OFF]pinSetIdx:%d \n",pinSetIdx);
	...
	{
		PK_DBG("kdCISModulePowerOff get in---  SENSOR_DRVNAME_OV2680_MIPI_RAW\n");
		PK_DBG("[OFF]pinSetIdx:%d \n",pinSetIdx);
...
/*task799146 modify by zhanyong.yin at 20151025 end*/
			   ...
			   && (0 == strcmp(SENSOR_DRVNAME_OV5648_MIPI_RAW, currSensorName))) {
			//mtkcam_gpio_set(pinSetIdx, CAMLDO, 0); //task799146 modify by zhanyong.yin at 20151025
			/* Set Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN]) {
				mtkcam_gpio_set(pinSetIdx, CAMPDN,
						pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
