...
#endif
//added by lanying.he for gsensor_back beginning
/*struct acc_hw accel_cust;
static struct acc_hw *hw = &accel_cust;*/
  struct acc_hw cust_accel_1;
static struct acc_hw *hw = &cust_accel_1;
//added by laying.he for gsensor_back end
