...
#endif
extern LCM_DRIVER pixi5_ili9806e_fwvga_dsi_tdt_lcm_drv;
extern LCM_DRIVER pixi5_jd9161ba_fwvga_dsi_boe_lcm_drv;
extern LCM_DRIVER pixi5_st7701_fwvga_dsi_each_lcm_drv;
extern LCM_DRIVER pixi5_ili9806e_fwvga_dsi_wtdt_lcm_drv;

LCM_DRIVER *lcm_driver_list[] = {
#if defined(PIXI5_ILI9806E_FWVGA_DSI_TDT)
	&pixi5_ili9806e_fwvga_dsi_tdt_lcm_drv,
#endif

#if defined(PIXI5_JD9161BA_FWVGA_DSI_BOE)
	&pixi5_jd9161ba_fwvga_dsi_boe_lcm_drv,
#endif

#if defined(PIXI5_ST7701_FWVGA_DSI_EACH)
	&pixi5_st7701_fwvga_dsi_each_lcm_drv,
#endif

#if defined(PIXI5_ILI9806E_FWVGA_DSI_WTDT)
	&pixi5_ili9806e_fwvga_dsi_wtdt_lcm_drv,
#endif
