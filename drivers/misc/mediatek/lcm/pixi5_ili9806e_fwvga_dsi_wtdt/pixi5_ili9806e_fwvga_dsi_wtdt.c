...
static struct LCM_setting_table lcm_tdt_initialization_setting[] = {
	...
	{0x40,	1,	{0x14}},	// 11 BT
	{0x41,	1,	{0x33}},	// 44 DVDDH DVDDL clamp 
	{0x42,	1,	{0x03}},	// VGH/VGL 
	...
	{0x51,	1,	{0x68}},	// VGMN
	{0x52,	1,	{0x00}},	// Flicker 
	{0x53,	1,	{0x40}},	// Flicker  83 adj by peter wang, 0x7c
	...
	{0xC1,	1,	{0x03}},	// Gamma 251   
	{0xC2,	1,	{0x0D}},	// Gamma 247  
	{0xC3,	1,	{0x11}},	// Gamma 239  
	{0xC4,	1,	{0x0A}},	// Gamma 231 
	{0xC5,	1,	{0x15}},	// Gamma 203  
	{0xC6,	1,	{0x0B}},	// Gamma 175   
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//params->dsi.lcm_esd_check_table[1].cmd          = 0x3D;
	//params->dsi.lcm_esd_check_table[1].count        = 1;
	//params->dsi.lcm_esd_check_table[1].para_list[0] = 0x00;  //page6

	//params->dsi.lcm_esd_check_table[2].cmd          = 0x00;
	//params->dsi.lcm_esd_check_table[2].count        = 1;
	//params->dsi.lcm_esd_check_table[2].para_list[0] = 0x21; //page6
	...
	// add by zhuqiang for FR437058 at 2013.4.25 end
 	params->dsi.PLL_CLOCK=205;//add by longfang.liu PR527476
        ...
        //LCD_DEBUG(KERN_ERR "[pixi5_ili9806e_fwvga_dsi_wtdt.c]Debug MIPI: params->dsi.PLL_CLOCK = %d\n", params->dsi.PLL_CLOCK);
        //LCD_DEBUG(KERN_ERR "[pixi5_ili9806e_fwvga_dsi_wtdt.c]Debug MIPI: params->dsi.ssc_range = %d\n", params->dsi.ssc_range);
}
...
static unsigned int lcm_compare_id(void)
{
	...
	if (id_type == 1 ) //ili9806e_wTDT  source ,and ID_tpye is 1. 
	{
		return 1 ;
	}
	else
...
// ---------------------------------------------------------------------------
LCM_DRIVER pixi5_ili9806e_fwvga_dsi_wtdt_lcm_drv =
{
	.name		= "pixi5_ili9806e_fwvga_dsi_wtdt",
